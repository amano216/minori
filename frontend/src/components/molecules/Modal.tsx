...
export function Modal({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className={`bg-white rounded-t-xl sm:rounded-lg shadow-xl w-full ${sizeStyles[size]} max-h-[90vh] flex flex-col`}
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        {/* Footer */}
        {footer && (
          <div className="flex items-center justify-end gap-2 sm:gap-3 px-4 sm:px-6 py-3 sm:py-4 border-t border-gray-200">
            {footer}
          </div>
        )}
      </div>
